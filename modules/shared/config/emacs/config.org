...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Rohit Jayaram"
    user-mail-address "tihor29@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/rohit/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/rohit/bin" "/profile/bin" "/Users/rohit/.npm-packages/bin" "/Users/rohit/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
