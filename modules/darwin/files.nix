...

{
  ...
  ".claude/skills/fix-merge-conflicts/SKILL.md".text = ''
    ...
    Use graphite `gt continue` to continue with the rebase. Pay attention to where in the stack you are with gt log etc
  '';

  ".claude/skills/remove-ai-slop/SKILL.md".text = ''
    # Remove AI code slop
    ...
    - Single line functions that wrap behavior that can just be inlined
    - Needless guards around calls when other usages do not have that
